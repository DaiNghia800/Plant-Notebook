...
const List<LibraryPlantItem> libraryPlantSeed = [
  LibraryPlantItem(
    ...
    description: 'Fiddle Leaf Fig (Bàng Singapore) nổi bật với tán lá to và dáng cao, hợp làm điểm nhấn trong phòng khách hoặc văn phòng.',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1593691512422-28cb17fb9b83?auto=format&fit=crop&w=1200&q=80',
    isTrending: true,
  ...
  LibraryPlantItem(
    ...
    description: 'Snake Plant (Lưỡi Hổ) là lựa chọn phù hợp cho người mới bắt đầu nhờ khả năng chịu hạn tốt và dễ thích nghi môi trường.',
    lightLevel: 'Ít sáng',
    waterNeed: 'Thấp',
    difficulty: 'Dễ',
    careGuide: [
  ...
  LibraryPlantItem(
    ...
    description: 'Monstera có lá xẻ đẹp mắt, phù hợp làm cây trang trí chủ đạo cho không gian sống theo phong cách hiện đại.',
    lightLevel: 'Sáng gián tiếp',
    waterNeed: 'Trung bình',
    difficulty: 'Dễ',
    careGuide: [
  ...
  LibraryPlantItem(
    ...
    description: 'String of Pearls là dòng sen đá thân rủ, nổi bật với chuỗi lá tròn như hạt ngọc và khả năng chịu hạn tốt.',
    ...
    funFacts: _defaultFunFacts,
    imageUrl: 'https://images.unsplash.com/photo-1526397751294-331021109fbd?auto=format&fit=crop&w=1200&q=80',
    isRare: true,
  ...
  LibraryPlantItem(
    ...
    description: 'Aloe Vera (Nha Đam) là loại mọng nước dễ sống, lá dày chứa gel thường dùng trong chăm sóc da tự nhiên.',
    ...
    funFacts: _defaultFunFacts,
    imageUrl: 'https://images.unsplash.com/photo-1509423350716-97f2360af9f4?auto=format&fit=crop&w=1200&q=80',
    badge: 'camera',
  ...
  LibraryPlantItem(
    ...
    description: 'Cây Trầu Bà là lựa chọn thân thiện cho người mới bắt đầu nhờ khả năng thích nghi tốt, tốc độ phát triển ổn định và dáng lá mềm mại rất hợp không gian sống hiện đại.',
    ...
    funFacts: _defaultFunFacts,
    imageUrl: 'https://images.unsplash.com/photo-1604762524887-5a1a5f2c4f43?auto=format&fit=crop&w=1200&q=80',
