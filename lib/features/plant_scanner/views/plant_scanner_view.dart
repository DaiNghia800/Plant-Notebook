...
import 'package:plant_notebook/features/plant_scanner/views/widget/camera_area/scan_bottom_bar.dart';
import 'package:plant_notebook/features/plant_scanner/views/widget/camera_area/scan_status_chip.dart';
import 'package:plant_notebook/features/plant_scanner/views/widget/camera_area/scanner_frame_overlay.dart';
import 'package:plant_notebook/features/plant_scanner/views/widget/camera_area/scanner_app_bar.dart';
import 'package:plant_notebook/features/plant_scanner/views/widget/camera_area/camera_preview_widget.dart';
import 'package:plant_notebook/features/plant_scanner/views/widget/camera_area/scanner_helper_text.dart';
import 'package:plant_notebook/features/plant_scanner/views/scan_result_view.dart';
...
class _PlantScannerViewState extends State<PlantScannerView>
  ...
  void _navigateToResult(String imagePath) {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(builder: (_) => ScanResultView(imagePath: imagePath)),
    );
  }
