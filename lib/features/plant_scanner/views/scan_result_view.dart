...
import 'package:plant_notebook/features/plant_scanner/views/widget/result_area/result_sliver_app_bar.dart';
import 'package:plant_notebook/features/plant_scanner/views/widget/result_area/result_info_card.dart';
import 'package:plant_notebook/features/plant_scanner/views/widget/result_area/result_states.dart';

class ScanResultView extends StatefulWidget {
  final String imagePath;

  const ScanResultView({super.key, required this.imagePath});
